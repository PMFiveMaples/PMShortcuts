...
niRead,AccessToken,\\Watson\Production\X\DP Use\Shared AHKs\Toolkit.ini, AccessTokens, ShortCutAccessToken, "ERROR - NO KEY FOUND!"
...
^+r:: ;c 🌟 Restart Theresa's ShortCutToolkit ⌨️ Ctrl+Shift++r | Pressing Ctrl+Shift+r will restart the ShortCutToolkit - use this if it freezes up on you.
{
	...
	Reload
	X:\DP Use\Shared AHKs\Toolkit.ini
}
...
IniRead, CurrentVer, PMShortcuts.ahk, INI_Section, version
...
ButtonEmailNCOAPAF:
+^m:: ;Ctrl+Shift+m | Ctrl+Shift+m will trigger this code
